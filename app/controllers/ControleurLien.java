...
public class ControleurLien extends Controller {
    ...
    public Result afficher(String article) {
        ...
        try {
            contenuArticle = new String(Files.readAllBytes(environment.getFile(String.format("/public/lien/%s.html", article)).toPath()));
