...
public class ControleurBillet extends Controller {
    ...
    public Result afficher(String article) {
        ...
        try {
            contenuArticle = new String(Files.readAllBytes(environment.getFile(String.format("/public/billet/%s.html", article)).toPath()));
